-- Migración para eliminar el campo 'priority' de acuerdo con el Manual de Identidad v2.1

-- 1. Eliminar la columna de la tabla tasks
alter table public.tasks drop column if exists priority;

-- 2. Eliminar la función existente ya que cambia el tipo de retorno (signature)
drop function if exists public.search_tasks(text, uuid, uuid[], uuid, text);

-- 3. Crear la nueva versión de la función
